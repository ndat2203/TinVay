...
<template>
<section
  class="py-[56px] lg:py-[87px] px-[16px] lg:px-8 lg:mt-[110px] bg-cover bg-center"
  :style="{
  ...
  <div class="flex items-end justify-between mb-14">
    ...
    <div>
      <NuxtLink
        ...
        class="bg-[#BB202E] text-white text-[18px] leading-[18px] font-medium rounded-2xl px-6 py-[15px] transition hover:text-[#F9663E] hidden lg:block cursor-pointer"
      >
        Xem tất cả
      </NuxtLink>
    </div>
